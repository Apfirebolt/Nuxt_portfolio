...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1, viewport-fit=cover"},{"name":"description","content":"A portfolio website of Amit Prafulla, a Full Stack Developer with 6+ years of experience working with web applications."},{"name":"format-detection","content":"telephone=no"},{"property":"author","content":"Apfirebolt"}],"link":[],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"en"},"title":"Apgiiit.com - My Portfolio"};
...
const entryFileName = "BWZUOWBZ.js";
...
export { VueResolver as V, buildAssetsURL as a, baseURL as b, headSymbol as h, injectHead as i, renderer as r };
